...
{
    public partial class TestUC : UserControl, IDocument
    {
		#region FIELDS
		...
		#region CONSTRUCTORS
			...
			public TestUC(TestConfiguration configuration, string filename)
			{
				// Initialize the components - mandatory line for UI
				InitializeComponent();
		...
		#region BACKGROUND EXECUTION
			...
			#region ENGINE EVENTS
                ...
                private void SelectFileLogOuputPath_HelpRequest(object sender, EventArgs e)
                {
